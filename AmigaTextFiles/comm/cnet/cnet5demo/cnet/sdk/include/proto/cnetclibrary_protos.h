...
short						CNC_compstra(char *s, char *t);
UBYTE						CNC_PutQ(char *a);
void						CNC_DoReturn(void);
void						CNC_MakeEd(char *path);
void						CNC_DeleteEd(void);
BPTR						CNC_OpenEd(long mode_d1);
void						CNC_PrepEditor(BPTR fp_a1);
void						CNC_SaveEditor(BPTR fp_a1, UBYTE eof_d1);
