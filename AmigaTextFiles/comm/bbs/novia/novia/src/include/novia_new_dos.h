...
#define NDOS_IIBTYPE_DIRECTORY	1
#define NDOS_IIBTYPE_FILE			2
#define NDOS_IIBTYPE_LINK			4
#define NDOS_IIBTYPE_FTPLINK		8
...
struct ItemInfoBlock
{
	...
	Date 	LastChange;	// 68
	Date	CreateDate;	// 80	true writing date
	...
	ULONG Access_Read;			// 112 groups which may Post
	ULONG	Access_Write;			// 116 ... Upload/Respong access
	ULONG Access_Execute;
	ULONG Access_

	UBYTE	Deleted;					// 133 Item is deleted

	UBYTE	Access_Youngest;				// 137
	UBYTE	Access_Oldest;					// 138
	UBYTE	Access_Gender;					// 139
	UBYTE	Access_DefDropped;				// 140

	UWORD	Access_MaxMins;					// 142 User can't read/enter item/subboard after ...
	UWORD	Access_FreeDays;				// 144 files are free in ... days
