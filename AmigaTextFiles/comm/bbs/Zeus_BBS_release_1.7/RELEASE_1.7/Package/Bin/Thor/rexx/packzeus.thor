/*
** PackZeus.thor -- Exports the latest written messages back to the BBS.
**
** (c) 1995 Nick Loman
*/
...
if rc = 0 then do
	...
	if RC = 0 then do
		...
		address command thorpath'Bin/packzeus BBSNAME 'Sys.BBSNAME' PUBSCREEN 'GCfg.PubScreenName
