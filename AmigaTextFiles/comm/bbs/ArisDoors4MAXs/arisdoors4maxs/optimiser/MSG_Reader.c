/******************************************************************************/
/******************************************************************************/
/* MESSAGES READER V0.01  WRITTEN BY ARI TSIRONIS                                   */
/******************************************************************************/
/******************************************************************************/
...
int err, i, first_msg,sections[50];
unsigned char sec1,sec2;
unsigned int text_size, flags;
unsigned long text_pnt;
  ...
  for(;;)
    {
      ...
      if((extract(data,0,L)>=first_msg+1000))
        {
          ...
          printf("\n\n******************************************************************************\n\n");    
          printf("Num=%d, pnt=%ld, size=%d Delete=%d Data Sec=%d Index Sec=%d\n\n",extract(data,0,L),text_pnt,text_size,flags&0x01,sec1,sec2);
