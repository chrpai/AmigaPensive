...
; **** Message-Direktanwahl
;
MENU="Msg-Direct"			; Name des Menues
...
_disk execute/keep "menu:'{alanguage}'/msg-direct.bat" ; Zusatz-Menuepunkte holen
_gosub PSCREEN				; Rest-Menuepunkte ausgeben

_disk text "menu:'{alanguage}'/msg-direct.txt" ; Menuetext ausgeben
...
_get dir/boards "'N'" N			; Naechstes Board suchen
BM'BC'=N				; Boardname speichern
_if N != "" then _goto CMENU_B_LOOP	; Board vorhanden ? Ja -> weiter suchen

_disk execute/keep "menu:'{alanguage}'/msg-direct-b.bat" ; Zusatz-Menuepunkte holen
...
_disk text "menu:'{alanguage}'/msg-direct-b.txt" ; Menuetext ausgeben
...
_get dir/board "" N			; Existiert Board in Diretory ?
...
GETDIRS_LOOP:
_get dir/dir/board N'LE' N		; Dirname einlesen
...
_menu/noecho "" -			; Tasten abfragen
 ...
 "^3" CBOARD_LEFT -
 "^4" CBOARD_RIGHT -
 "^M" CBOARD_READ -			; Menuepunkt zum Lesen anwaehlen
 "^R" CBOARD_REFRESH -			; Bildschirm refreshen
 "B" CBOARD_CLI -			; Befehlsebene
 "M" CBOARD_MARK -			; Board aus Liste ein-/austragen
 "Q" CBOARD_EXIT -			; Ende des Menues
 "R" CBOARD_READ -			; Menuepunkt zum Lesen anwaehlen
 "W" CBOARD_WRITE			; Menuepunkt zum Schreiben anwaehlen
...
_check board/boardlist "'N'" CBOARD_T	; Board in Boardliste ? Nein -> verzw.
_read/action=106 "'N'"			; Board aus Boardliste nehmen
INDEX=BPOS
...
CBOARD_T:
_read/action=105 "'N'"			; Board in Boardliste aufnehmen
INDEX=BPOS
F=BF2					; Setz-Farbe setzen
_gosub PBOARD				; Menuepunkt neu ausgeben
_goto CBOARD1				; -> Neue Taste abfragen
...
;
CBOARD_READ:
COM="CBOARD_READ"			; Menupunkt setzen
...
N=BM'BPOS'				; Boardname holen
_check board/acc=1 "'N'" CBOARD1	; Falls kein Lese-Zugriff -> Taste ignorieren
...
;
CBOARD_WRITE:
COM="CBOARD_WRITE"			; Menupunkt setzen
_if/i BPOS >= BC-2 then _goto CBOARD1	; Exit-Menuepunkt ? Ja -> Taste ignorieren

N=BM'BPOS'				; Boardname holen
_check board/acc=2 "'N'" CBOARD1	; Falls kein Schreib-Zugriff -> Taste ignorieren
T=1					; Bildschirm geloescht signalisieren
_echo/nolf "#RESET##HOME##CLS#"		; Bildschirm loeschen
_write "'N'"				; Board schreiben
_goto CBOARD_REFRESH			; -> Bildschirm refreshen
...
_check board/boardlist "'N'" PBOARD_PRINT
...
M=" "					; Board nicht in Boardliste
_check board/boardlist "'N'" PALLBOARDS_PRINT
M="*"					; Board in Boardliste
PALLBOARDS_PRINT:
_echo/nolf "#SETPOS 'Y','X'#'F'{LIMSPACEON}{TAB 26}{LIMSPACEOFF}#LEFT 26#'M' 'N'"
I=I+1					; Feldnummer auf naechsten Menuepunkt
