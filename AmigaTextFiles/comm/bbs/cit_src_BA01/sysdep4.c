...
struct variables variable[MAXVARS] =
  {
    ...
    { "currdate",    FUNC2_PT, (unsigned short *)NormalformDate   }, /*25*/
...
static char *msgbuffer=NULL;   /* Initialized from available memory */
