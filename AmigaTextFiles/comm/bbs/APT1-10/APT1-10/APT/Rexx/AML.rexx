/* AML.rexx
**
** $VER: AML 0.0.1 (26.4.93)
**
** ARexx program for controlling ApT-BBS by ApT-Design.
**
** Copyright © 1993 ApT-Design All Rights Reserved,TS,AG
**
...
** spat "aml.rexx" #?.tpl
**
** Converted to work with 'spat' by AG,.. Just a quick hack to
** get you converting those menus fastly.. :)
**
** Added the 'NL' command to replace \n's correctly within
** .apt rexx scripts..
**
** Credit goes to Tom Snow for 99% of this..
**
*/
...
outfile="ram:stuff/"infile

if ~open('in',infile,'R') then DO
	say 'Cannot open 'infile' MCI source file!'
	EXIT
END
...
say 'Working on sourcefile "'infile'" and outputting to "'outfile'"'
