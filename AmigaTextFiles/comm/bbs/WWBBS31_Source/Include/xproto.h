...
struct XPR_IO {
                STRPTR   xpr_filename;      /* File name(s)             */
                  ...
                  LONG __asm (*xpr_fread)();      /* Get UBYTE from file       */
                  LONG __asm (*xpr_fwrite)();     /* Put string to file       */
                 ULONG __asm (*xpr_sread)();      /* Get UBYTE from serial     */
                  LONG __asm (*xpr_swrite)();     /* Put string to serial     */
                  LONG __asm (*xpr_sflush)();     /* Flush serial input buffer*/
                  LONG __asm (*xpr_update)();     /* Print stuff              */
                  LONG __asm (*xpr_chkabort)();   /* Check for abort          */
                  LONG __asm (*xpr_chkmisc)();    /* Check misc. stuff        */
                  LONG __asm (*xpr_gets)();       /* Get string interactively */
                  LONG __asm (*xpr_setserial)();  /* Set and Get serial info  */
                  LONG __asm (*xpr_ffirst)();     /* Find first file name     */
                  LONG __asm (*xpr_fnext)();      /* Find next file name      */
                  LONG __asm (*xpr_finfo)();      /* Return file info         */
                  LONG __asm (*xpr_fseek)();      /* Seek in a file           */
                  LONG   xpr_extension;     /* Number of extensions     */
                  LONG  *xpr_data;          /* Initialized by Setup.    */
                 ULONG __asm (*xpr_options)();    /* Multiple XPR options.    */
                  LONG __asm (*xpr_unlink)();     /* Delete a file.           */
                  LONG __asm (*xpr_squery)();     /* Query serial device      */
                  LONG __asm (*xpr_getptr)();     /* Get various host ptrs    */
              };
...
#define XPRS_NOUPDATE   0x00008000L	/* NEW! */
#define XPRS_XPR2001    0x00010000L	/* NEW! */
#define XPRS_DOUBLE     0x00020000L	/* NEW! */
/*
